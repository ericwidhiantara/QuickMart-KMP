...
sealed class AppScreen(val route: String) {
    ...
    /// ORDER
    data object OrderListScreen : AppScreen(ConstantAppScreenName.ORDER_LIST_SCREEN)
    data object OrderDetailScreen : AppScreen(ConstantAppScreenName.ORDER_DETAIL_SCREEN)

    /// CART
    data object MyCartScreen : AppScreen(ConstantAppScreenName.MY_CART_SCREEN)

    /// WISHLIST
    data object MyWishlistScreen : AppScreen(ConstantAppScreenName.MY_WISHLIST_SCREEN)
    ...
    data object CheckPasswordScreen :
        AppScreen(ConstantAppScreenName.CHECK_PASSWORD_SCREEN)
...
object ConstantAppScreenName {
    ...
    /// WISHLIST
    const val MY_WISHLIST_SCREEN = "my_wishlist_screen"
