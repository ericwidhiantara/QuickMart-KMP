...
interface ProfileRepository {
    ...
    suspend fun updateProfile(params: UpdateProfileParamsEntity): Flow<ApiResponse<ResponseDto<UserEntity>>>
    suspend fun deleteAccount(): Flow<ApiResponse<ResponseDto<Unit>>>
}
